...
/*Problemas solucionados: *Variable clone no utilizada(no genera ningun cambio en el algoritmo)
                          *Cadena original mal declarada
                          *No se habia reservado memoria para ouput
                          *GDB indica que length toma un valor de 1454 en string_clone
                          *Nunca se liberaba la memoria utilizada por copy
*/