...
/*Problema al cambiar el tipo a *original = "" se da debido al sizeof(*original), y tambien debemos de tener en cuenta que al declarar asi la variable tendriamos una cadena nula*/