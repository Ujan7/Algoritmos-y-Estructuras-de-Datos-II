...
struct s_queue 
{
    struct s_node *last; /*Gives acces to the last node*/
    unsigned int size; /*Indicates the actual size of the queue*/
    struct s_node *first;
};
